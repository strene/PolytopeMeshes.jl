# Show Option Values for composite_pebi_grid_2d
#
# This example demonstrates all the major options for composite_pebi_grid_2d,
...
## 1. cell_constraints
# Cell constraints are traced by cell centroids in the grid.
...
# cc_factor=0.5 means half the reservoir grid spacing.
println("=== 2. cc_factor ===")
...
## 6. face_constraints
# Face constraints are traced by faces (edges) of the grid.
